...
/**
 * This file the eZRole PHP Class has been modified to provide the new hasPolicy method.
 * This complete class modified to provide additional features is provided as a reference for kernel override extensions (using eZ Publish 4.x+) or kernel patches (using eZ Publish 3.x or some other non-standard configuration). 
